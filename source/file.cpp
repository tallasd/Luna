...
void fs::copyFile(FsFileSystem *fs, const std::string& from, const std::string& to, tsl::elm::Log **logelm)
{
...
void fs::copyDirToDir(FsFileSystem *fs, const std::string& from, const std::string& to, tsl::elm::Log **logelm)
{
    dirList list(from);
