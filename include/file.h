...
//64kb of buffer bc tesla got syssy memory pool //WerWolv said he uses 4kb
...
namespace fs
{
    ...
    void copyDirToDir(FsFileSystem *fs, const std::string &from, const std::string &to, tsl::elm::Log **logelm);
